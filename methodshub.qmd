...
`webtrackR` accepts accepts raw webtracking data as provided by GESIS and includes a sample dataset of raw webtracking data. 
...
webtrackR runs on any hardware that can run R.
